 ...
 it("sets state variables ",function(){
  ...
  it("sets total supply and allocates them  to token holder",function(){
     return EToken.deployed().then(function(instance){
         ...
         return Instance.BalanceOf('0xc57F3fA39142B579Cc44Af38A69a6DC2dE3539E3');
  ...
  it("return tokens of a  particular account ", function(){
      return EToken.deployed().then(function(instance){
          Instance = instance;
          return Instance.BalanceOf('0x1f41E86D17325e8d0887F7d81c99Ba159eD4C0Ba');
...
//        return EToken.deployed().then(function(instance){
//              Instance = instance;
//              return Instance.transfer('0x1f41E86D17325e8d0887F7d81c99Ba159eD4C0Ba',100000);
